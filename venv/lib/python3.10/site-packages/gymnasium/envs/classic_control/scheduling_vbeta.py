...
class SchedulingEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
    ...
    def reset(
        ...
        *,
        ...
        self.state = get_nodes_network_usage(["172.19.0.4", "172.19.0.3", "172.19.0.11"])
        print(f"RESET STATE: {self.state}")

        self.num_of_nodes = node_count()
        self.network_usage_metrics = get_nodes_network_usage(["172.19.0.4", "172.19.0.3", "172.19.0.11"])
    ...
    def step(self, action):
        ...
        if terminated:
            node_names= ["172.19.0.4", "172.19.0.3", "172.19.0.11"]
